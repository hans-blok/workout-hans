#!/usr/bin/env python3
"""
Runner voor Personal Trainer agent

Zie: governance/rolbeschrijvingen/personal-trainer.md
Prompt: .github/prompts/personal-trainer.prompt.md

Gebruik:
    python scripts/personal-trainer.py [argumenten]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Personal Trainer agent runner",
